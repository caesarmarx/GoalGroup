...
public class BreakUpClubHttp extends GoalGroupHttpPost {

	private int error;
	private int datas;
	
	public BreakUpClubHttp() {
		super();
	...
	public void setParams(Object... params) {
		...
		post_params.add(new BasicNameValuePair("cmd", "break_club"));
	...
	private void checkResult() {
		datas = JSONUtil.getValueInt(result, "break_status");
