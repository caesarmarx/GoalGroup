...
public class SearchPlayerListHttp extends GoalGroupHttpPost {
	
	private int error;
	private String datas;
	private String more;
	
	public SearchPlayerListHttp() {
		super();		
	...
	public void setParams(Object... params) {
		post_params.add(new BasicNameValuePair("cmd", "search_player_list"));
		...
		post_params.add(new BasicNameValuePair("position", String.valueOf(params[2])));
		post_params.add(new BasicNameValuePair("Activity_Time", String.valueOf(params[3])));
		post_params.add(new BasicNameValuePair("Activity_Area", (String)params[4]));
		post_params.add(new BasicNameValuePair("page", String.valueOf(params[5])));
