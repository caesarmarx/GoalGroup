...
public class ClubMarketSearchActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_club_market_search);
		...
		ll_areaName = (LinearLayout)findViewById(R.id.area_location_name);
	...
	private void setViewArea() {
		...
		LinearLayout.LayoutParams textViewLp = new LinearLayout.LayoutParams(0,
				LayoutParams.FILL_PARENT, 0.25f);
		...
		for (int i = 0; i < selAreaConds.length; i++) {
			...
			areaName[i].setTextColor(0xffcfcfcf);
