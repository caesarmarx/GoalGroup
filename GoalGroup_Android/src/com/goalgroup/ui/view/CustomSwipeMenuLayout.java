 ...
 * 
 */
public class CustomSwipeMenuLayout extends FrameLayout {
	...
	private CustomSwipeMenuView mMenuView;
	private int mDownX;
	...
	private float menuStart, menuEnd;
	private boolean radiusFlag = false;

	public CustomSwipeMenuLayout(View contentView, CustomSwipeMenuView menuView) {
		this(contentView, menuView, null, null, 0, 0);
	}

	public CustomSwipeMenuLayout(View contentView, CustomSwipeMenuView menuView,
			Interpolator closeInterpolator, Interpolator openInterpolator, float start, float end) {
	...
	private CustomSwipeMenuLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private CustomSwipeMenuLayout(Context context) {
		super(context);
	}
...
////////		
		/*FrameLayout.LayoutParams fLayParams = (FrameLayout.LayoutParams) mMenuView.getLayoutParams();
		fLayParams.leftMargin = -100;
		mMenuView.setLayoutParams(fLayParams);*/
	...
	private void swipe(int dis) {
		...
		mMenuView.layout(mContentView.getWidth() - dis, mContentView.getTop(),//kyr_2015_04_28 dp2px(3)
				mContentView.getWidth() + mMenuView.getWidth() - dis,
				mMenuView.getBottom());
		mMenuView.setTop(mContentView.getTop());
	}
	...
	public CustomSwipeMenuView getMenuView() {
		return mMenuView;
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (menuStart == 0 && menuEnd == 0)
			mMenuView.layout(getMeasuredWidth(), 0,
			 ...
			 mMenuView.layout(getMeasuredWidth(), (int)(mContentView.getMeasuredHeight() * menuStart),
						getMeasuredWidth() + mMenuView.getMeasuredWidth(),
						(int)(mContentView.getMeasuredHeight() * menuEnd));
