...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        CGRect detailFrame = CGRectMake(CGRectGetMinX(textFrame),
                                        ...
                                        notificationWidth - __imagePadding * 2 - CGRectGetMaxX(_imageView.frame) - 28,
        ...
        CGRect buttonFrame = CGRectMake(detailFrame.origin.x + detailFrame.size.width, 6, 28, 28);
        UIButton *cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [cancelButton setBackgroundImage:[UIImage imageNamed:@"cancel"] forState:UIControlStateNormal];
        [cancelButton setBackgroundImage:[UIImage imageNamed:@"cancel_sel"] forState:UIControlStateHighlighted];
                          ...
                          andTouchBlock:(MPNotificationSimpleAction)block
{
    ...
    UITapGestureRecognizer *gr = [[UITapGestureRecognizer alloc] initWithTarget:notification action:@selector(handleTap:)];
...
- (void)cancelPressed
{
    [__notificationWindow.notificationQueue removeAllObjects];
    [NSObject cancelPreviousPerformRequestsWithTarget:[self class]
                                             selector:@selector(showNextNotification)
                                               object:nil];
    [MPNotificationView showNextNotification];
