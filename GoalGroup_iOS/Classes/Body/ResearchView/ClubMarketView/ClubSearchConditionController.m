//
//  ClubSearchConditionController.m
//  GoalGroup
//
...
@interface ClubSearchConditionController ()
{
    NSArray *ageLabels;
    NSArray *weekLabels;
...
@implementation ClubSearchConditionController
+ (id)sharedInstance
{
    @synchronized(self)
    {
        if (gClubSearchConditionController == nil)
            gClubSearchConditionController = [[ClubSearchConditionController alloc] init];
    }
    return gClubSearchConditionController;
}
...
- (void)layoutComponents
{
    ...
    NSInteger h =  40;
    NSInteger maxViewHeight = SCREEN_HEIGHT - 80;
    NSInteger curViewHeight = 0;
    
    _searchCondWeekLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 60 + h, 300, 20)];
    ...
    _searchCondAreaLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 155 + h, 300, 20)];
    ...
    _weekLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(25, 100 + h, 40, 20)];
    _weekLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(70, 100 + h, 40, 20)];
    _weekLabel3 = [[UILabel alloc] initWithFrame:CGRectMake(115, 100 + h, 40, 20)];
    _weekLabel4 = [[UILabel alloc] initWithFrame:CGRectMake(165, 100 + h, 40, 20)];
    _weekLabel5 = [[UILabel alloc] initWithFrame:CGRectMake(210, 100 + h, 40, 20)];
    _weekLabel6 = [[UILabel alloc] initWithFrame:CGRectMake(255, 100 + h, 40, 20)];
    _weekLabel7 = [[UILabel alloc] initWithFrame:CGRectMake(25, 120 + h, 40, 20)];
    ...
    for (NSDictionary *area in [[DistrictManager sharedInstance] districtsWithCityIndex:curCityID]) {
        ...
        UILabel *_areaLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(x, 180 + y + h, size.width, 20)];
    ...
    curViewHeight = 180 + y + h + 20 + 60 + 40;
    scrollView.contentSize = CGSizeMake(SCREEN_WIDTH, curViewHeight < SCREEN_HEIGHT? curViewHeight : SCREEN_HEIGHT);
    ...
    searchLabels = [NSArray arrayWithObjects:ageLabels, weekLabels, areaLabels,nil];
    
    searchKeyLabels = [NSArray arrayWithObjects:_AgeCondition, _WeekCondition, _ActAreaCondition, nil];
    
    //Button's event
    _cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
    _cancelButton.frame =  CGRectMake(30, 300, 110, 40);
    ...
    _okButton.frame =  CGRectMake(177, 300, 110, 40);
...
- (IBAction)doSelect:(UITapGestureRecognizer *) gesture
{
    ...
    CGFloat red = 0.0f, blue = 0.0f, green = 0.0f, alpha = 0.0f; //Added By Boss.2015/05/02
            ...
            else
            {
                ...
                for (int ii = 0; ii < temp.count; ii ++) {
                    ...
                    for (NSDictionary *area in [[DistrictManager sharedInstance] districtsWithCityIndex:curCityID])
                    {
                        ...
                        {
                            ida = [area valueForKeyPath:@"id"];
                            break;
                        }
                    }
                
                    if ([activeArea isEqualToString:@""])
                        activeArea = [NSString stringWithFormat:@"%@", ida];
                    else
                        activeArea = [NSString stringWithFormat:@"%@,%@", activeArea, ida];
                }
            }
        }
    }
    
    condition = [NSMutableArray arrayWithObjects:minAge, maxAge, activeTime, activeArea, nil];
    [self.delegate clubSearchWithCondition:condition];
...
-(void)viewWithCondition
{
    if (condition && condition.count >0)
    {
        ...
        NSString *activeTime = [NSWeek stringWithIntegerWeek:[condition[2] intValue]];
        ...
        NSString *activeArea = (NSString *)condition[3];
